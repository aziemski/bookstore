...
var ErrTxStarted = errors.New("entgo: cannot start a transaction within a transaction")
...
func (c *Client) Tx(ctx context.Context) (*Tx, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("entgo: starting a transaction: %w", err)
	}
	cfg := c.config
	cfg.driver = tx
	return &Tx{
...
func (c *Client) Mutate(ctx context.Context, m Mutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("entgo: unknown mutation type %T", m)
	}
}
...
func (c *BookClient) mutate(ctx context.Context, m *BookMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("entgo: unknown Book mutation op: %q", m.Op())
	}
}
